...
export function JobsPage() {
  ...
  return (
    <div className="space-y-4">
      <PageShell
        title="Jobs"
        description="Track indexing progress through Queued, Cloning, Discovering files, Parsing, Building relationships, Chunking, Embedding, Validating, and Completed."
      />
